...
export default function AdminProjects() {
  ...
  // Convert comma-separated string to object for storage
  const parseTechStacks = (str) => {
    if (!str) return {};
    return str.split(",").reduce((acc, tech, idx) => {
  ...
  // Convert techStacks object to comma-separated string for form
  const techStacksToString = (obj) => {
    if (!obj) return "";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const projectData = {
        ...
        techStacks: parseTechStacks(formData.techStacks),
  ...
  const handleEdit = (project) => {
    setFormData({
      ...
      techStacks: techStacksToString(project.techStacks),
          ...
          <form onSubmit={handleSubmit} className="w-full bg-white border border-gray-200 rounded-xl p-5 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-white text-gray-800 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-300 text-sm"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="ReactJS, TailwindCSS, Firebase"
                  className="w-full px-3 py-2 bg-white text-gray-800 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-300 text-sm"
                />
              ...
              <div>
                ...
                <div
                  ...
                  className="w-full border-2 border-dashed border-gray-300 rounded-md flex items-center justify-center cursor-pointer hover:border-gray-500 hover:bg-gray-50 transition-colors overflow-hidden"
                  style={{ height: "42px" }}
                >
                  {previewUrl ? (
            ...
            <div className="mt-4">
              ...
              <textarea
                ...
                className="w-full px-3 py-2 bg-white text-gray-800 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-300 text-sm resize-none"
              />
            </div>
            ...
            <div className="flex gap-2 mt-4 justify-end">
              ...
              <button
                ...
                className="px-5 py-2 rounded-md text-sm font-medium text-white bg-gray-700 hover:bg-gray-800 disabled:opacity-50"
              >
                {isUploading
                    ...
                    <div className="p-3 flex flex-col flex-1">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <span className={`text-xs px-2 py-0.5 rounded-full shrink-0 font-medium
                          ${project.category === "project" ? "bg-green-100 text-green-700"
                          : project.category === "template" ? "bg-gray-100 text-gray-700"
                          : project.category === "components" ? "bg-purple-100 text-purple-700"
                          : "bg-yellow-100 text-yellow-700"}`}>
                          {project.category}
                        </span>
                      </div>

                      {project.techStacks && Object.values(project.techStacks).length > 0 && (
                        <div className="flex flex-wrap gap-1 mt-2">
                          {Object.values(project.techStacks).slice(0, 3).map((tech, i) => (
                            <span key={i} className="text-xs bg-gray-50 border border-gray-200 rounded px-1.5 py-0.5 text-gray-500 font-mono">
                              # {tech}
                            </span>
                          ))}
                        </div>
