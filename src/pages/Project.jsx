            ...
            <div key={project.id} className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-3">
                ...
                <div className="flex gap-3">
                  {project.code_url && (
                    <a href={project.code_url} target="_blank" rel="noopener noreferrer" className="flex-1 text-center bg-gray-100 hover:bg-gray-200 border border-gray-200 text-gray-800 font-medium py-2 px-3 rounded-md transition-colors text-sm">Source Code</a>
                  )}
                </div>
              </div>
            </div>
